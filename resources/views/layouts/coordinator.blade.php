...
<head>
	...
	<title>Koordinator_E-Grasud</title>
				...
				<div id="userbox" class="userbox">
					...
					<div class="dropdown-menu">
						<ul class="list-unstyled">
							<li class="divider"></li>
							<li>
								<a role="menuitem" tabindex="-1" href="{{ url('coordinatoruser') }}"><i class="fa fa-user"></i> My Profile</a>
							</li>
							{{-- <li>
					...
					<div class="nano-content">
						<nav id="menu" class="nav-main" role="navigation">
							<ul class="nav nav-main" >
								<li {{ Request::is('homecoordinator') ? 'class=nav-active' : '' }} >
									<a href="{{ route('homecoordinator') }}" style="color: white">
								...
								<li>
									<a href="{{ url('complaintuser') }}" style="color: white">
										{{-- <span class="pull-right label label-primary">182</span> --}}
