...
<div class="row">
	...
	<div class="col-md-8">
		<form action="{{ route('proofs.update',$proofs->id) }}" enctype="multipart/form-data" files="true" method="post">
			@method('put')
			@csrf
			...
			<section class="panel panel-primary">
				<header class="panel-heading">
					...
					<a class="mb-xs mt-xs mr-xs btn btn-default pull-right" href="{{ url('proofs') }}"><i class="fa fa-arrow-left"> </i> Kembali</a>
