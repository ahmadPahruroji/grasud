			...
			<section class="panel panel-primary">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" name="title" class="form-control" placeholder="Tulis Disini" required/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						{{-- <label class="col-sm-4 control-label">Tanggal</label> --}}
						<div class="col-sm-8">
							<input type="hidden" name="publish" value="0" class="form-control" placeholder="Tulis Disini" required/>
						</div>
					</div>
				</div>
