			...
			<section class="panel panel-primary">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select id="pengguna" class="form-control" name="user_id">
								...
								{{-- <option value="YA">Tidak Ada2</option> --}}
							</select>
						</div>
					</div>
					...
					<div class="form-group" id="pilih2" style="display: none;">
						...
						<div class="col-sm-8">
							{{-- <select class="form-control" name="month" hidden />
					...
					<div class="form-group">
						<div class="col-sm-8">
							<input type="hidden" name="status" value="1" class="form-control" placeholder="Tulis Disini" required/>
						</div>
					</div>
				</div>
