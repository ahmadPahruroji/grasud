        ...
        <table class="table table-bordered table-striped" id="datatable-ajax">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span>
                    <form action="{{ route('complaintuser.status', $complaint->id) }}" method="post">
                      @csrf
                      ...
                      <button type="link" onclick="return confirm('apakah sudah di proses?');" value="1" class="btn btn-warning btn-sm"><b>proses</b></button>
                      @else
