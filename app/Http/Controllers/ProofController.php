...
class ProofController extends Controller
{
    ...
    {
        //
        $data["proofs"] = Proof::orderBy('created_at','desc')->get();
        $name['user'] = User::with('biodata')->find(Auth::user()->id);
        return view('admin/proof.index', $data, $name);
    }
    ...
    public function create()
    {
        ...
        $data["users"] = User::get();
        $name['user'] = User::with('biodata')->find(Auth::user()->id);
        return view('admin/proof.create',$data, $name);
    }
    ...
    public function edit($id)
    {
        ...
        $data["users"] = User::get();
        $name['user'] = User::with('biodata')->find(Auth::user()->id);
        return view('admin/proof.edit',$data, $name);
    }
